package com.example.microservices.currencyconversion.model;
...
public class CurrencyConversion {
	...
	public CurrencyConversion(Long id, String from, String to, BigDecimal convertionValue, BigDecimal quantity,
